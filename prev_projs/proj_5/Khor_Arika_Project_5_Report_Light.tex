...
% Light Theme Colors (Clean Academic Look)
...
\fancyhf{}
\lhead{Project 5}
\chead{MPI Distributed Programming}
\rhead{Semester: SPRING 2026}
\lfoot{Arika Khor}
\cfoot{}
...
\begin{center}
    {\Large \textbf{Project 5 Report: Distributed Memory Parallelism with MPI}}\\
    \vspace{0.5em}
    Author: Arika Khor
\end{center}
...
\section*{Problem 1: Ping-Pong Benchmark and Interconnect Analysis}
...
\begin{figure}[h]
    ...
    \caption{Problem 1: Array Size vs. One-Way Transmission Time (Left: Same Node, Right: Different Nodes)}
\end{figure}
...
\section*{Problem 2: Parallel Dot Product with Collectives}
...
\section*{Problem 3: Merge Sort (yay back to data structures)}
...
\midrule
\textbf{4 Processes (Same Node)} & 0.029424 s & 0.029800 s & 0.033096 s \\
\textbf{4 Processes (Diff Nodes)} & 0.038150 s & 0.041220 s & 0.048950 s \\
\bottomrule
\end{tabular}
\end{center}
The comparison between same-node and cross-node execution reveals the significant impact of network latency on the tree-merge algorithm. Running on different nodes increases the overhead of the final merge stages, where large sorted chunks must be transmitted across the InfiniBand interconnect.
...
Processors & Time (s) & Speedup & Efficiency \\
\midrule
\textbf{2 Processes} & 0.111745 & 1.00 & 50.0\% \\
\textbf{4 Processes} & 0.118453 & 0.94 & 23.5\% \\
\textbf{8 Processes} & 0.108507 & 1.03 & 12.8\% \\
\textbf{16 Processes} & 0.125100 & 0.89 & 5.5\% \\
\bottomrule
\end{tabular}
\end{center}
...
\section*{Performance and MPI Bottlenecks}
...
\section*{AI Usage and Software Engineering Workflow}
